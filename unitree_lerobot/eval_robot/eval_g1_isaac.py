...
from unitree_lerobot.eval_robot.make_robot_new import (
    setup_image_client,
...
def eval_policy(
    ...
    try:
        # --- Setup Phase ---
        image_client = setup_image_client(cfg)
        ...
        if user_input.lower() == "s":
            ...
            while True:
                ...
                # 1. Get Observations
                observation, current_arm_q = process_images_and_observations(image_client, arm_ctrl)
